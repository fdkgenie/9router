...
export const APIKEY_PROVIDERS = {
  ...
  ramclouds: { id: "ramclouds", alias: "ramclouds", name: "Ramclouds", icon: "cloud", color: "#6366F1", textIcon: "RC", website: "https://ramclouds.me" },
...
export const USAGE_SUPPORTED_PROVIDERS = ["antigravity", "kiro", "github", "codex", "ramclouds"];
